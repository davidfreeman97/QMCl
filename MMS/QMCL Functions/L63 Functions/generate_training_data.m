function [training_data] = generate_training_data(amount_of_training_data, training_timestep, starting_point)
...
t(1)=0.0;
x(1)=starting_point(1); y(1)=starting_point(2); z(1)=starting_point(3);
%x(1)=2; y(1)=2; z(1)=2;   
