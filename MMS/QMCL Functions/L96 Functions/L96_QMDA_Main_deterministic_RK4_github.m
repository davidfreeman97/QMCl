function [data] = L96_QMDA_Main_deterministic_RK4_github(amount_of_new_data, F, generate_data, training_data, initial_training_state, initial_classical_state, K_val, training_eps, meas_eps)
...
raw_training_data = generate_l96_training_data(initial_training_state, F, hx, hy, epsilon, nx, ny, training_timestep);  
else 
...
new_rho = update_rho_l96(intermediate_rho, phi, new_covariate, training_data, nx, meas_eps);
