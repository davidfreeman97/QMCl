function [data] = L96_QMDA_Main_deterministic_RK4_old(amount_of_new_data, F, generate_data, training_data, initial_training_state, initial_classical_state, training_amount)
